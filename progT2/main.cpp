...
int main(){
	...
	menu_gerircondutores->	addOption("Editar Condutor", 'e', menu_interface, DRIVER_EDIT);
	menu_gerircondutores->	addOption("Remover Condutor", 'r', menu_interface, DRIVER_REMOVE);

	menu_gerirhorarios	->	addOption("Ver horario por linha", 'l', menu_interface, DRIVER_REMOVE);
	menu_gerirhorarios	->	addOption("Ver horario por paragem", 'p', menu_interface, DRIVER_REMOVE);
	menu_gerirhorarios	->	addOption("Ver horario por condutor", 'c', menu_interface, DRIVER_REMOVE);
